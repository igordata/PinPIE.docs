...
<article>
	...
	<section>
		...
		<ul>
			...
			<li>
				Конфиг выбирается в зависимости от имени сервера &mdash; удобно разрабатывать с локальным конфигом, деплоить
	...
	<section>
		...
		<p>
			PinPIE спроектирован так чтобы выдавать страницу за считанные миллисекунды даже на дешёвом VPS/VDS хостинге.
	...
	<section>
		...
		<p>
			Установить PinPIE можно через composer, или просто скачать и подключить autoload.php.
			Более подробные инструкции по настройке и запуску PinPIE <a href="/ru/manual/start">читайте тут</a>.
		</p>
	</section>
	<section>
		<header>
...
├── pinpie/                              примерное место для файлов PinPIE в случае самостоятельной установки
